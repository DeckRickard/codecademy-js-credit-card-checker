...
const validateCred = credArray => { // Uses a Luhn algorithm to validate a credit card number.
    let sum = 0;
    let count = 1; // Used to keep track of how many digits we have iterated through.
